...
async function Header() {
    ...
    return (
        <>
        <div className={'flex justify-between items-center py-2 lg:py-4 bg-gradient-to-r from-[#003247] to-black px-4 lg:px-20'}>
            <Link href={'/home'}>
                <div className={'flex flex-row items-center justify-center text-center text-white gap-2'}>
            ...
            <div className={'hidden lg:flex flex-row items-center gap-2 text-white'}>
                {user ? <div>{user.email}</div>: <Link className={'text-xs lg:text-sm'} href={'/login'}>로그인/회원가입</Link>}
